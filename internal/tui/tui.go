...
func New() tea.Model {
	return model{
		screen: screenMenu,
		items: []menuItem{
			{icon: "◆", title: "Smart Scan", description: "Overview of cleanable space, disk, and memory.", command: "opti-mac scan", action: actionScan},
			{icon: "◈", title: "Deep Clean Preview", description: "Find user caches, logs, app states, dev caches, temp files.", command: "opti-mac clean", action: actionCleanPreview},
			{icon: "▲", title: "Run Deep Clean", description: "Delete user and sudo-only system cleanup targets after confirmation.", command: "opti-mac clean --execute --sudo", action: actionCleanExecute},
			{icon: "◇", title: "Large Files", description: "Choose a scope, then find, select, and delete large files.", command: "opti-mac analyze --limit 200 --min-size 50MB <scope>", action: actionAnalyzeDownloads},
			{icon: "◎", title: "Duplicates", description: "Find duplicate files in Downloads, including small files.", command: "opti-mac duplicates ~/Downloads", action: actionDuplicatesDownloads},
			{icon: "◢", title: "Project Artifacts", description: "Find regenerable build/dependency dirs in the current folder.", command: "opti-mac artifacts .", action: actionArtifacts},
			{icon: "◰", title: "Updates", description: "Show outdated Homebrew formulae and casks.", command: "opti-mac updates", action: actionUpdates},
			{icon: "◱", title: "Login Items", description: "List login items and launch agents that run automatically.", command: "opti-mac login list", action: actionLoginItems},
			{icon: "◭", title: "Threat Scan", description: "Scan for known adware and PUP signatures.", command: "opti-mac threats", action: actionThreats},
			{icon: "❖", title: "Hidden Space", description: "Find snapshots, backups, Docker, and app caches eating disk.", command: "opti-mac space", action: actionSpace},
			{icon: "⊘", title: "Orphans", description: "Find leftover data from apps that are no longer installed.", command: "opti-mac orphans", action: actionOrphans},
			{icon: "✚", title: "Doctor", description: "Read-only check of FileVault, firewall, disk, and memory.", command: "opti-mac doctor", action: actionDoctor},
			{icon: "⌫", title: "Uninstall Apps", description: "Browse installed apps by size and remove one with its leftovers.", command: "opti-mac apps", action: actionApps},
			{icon: "◌", title: "Optimize RAM", description: "Purge inactive memory. macOS may ask for an admin password.", command: "opti-mac optimize --ram --sudo", action: actionOptimizeRAM},
			{icon: "■", title: "System Status", description: "Show host, CPU, disk, and memory details.", command: "opti-mac status", action: actionStatus},
